...
<body class="flex flex-col min-h-screen justify-between text-base" :class="{'overflow-hidden': opendropdown, 'overflow-y-auto': !opendropdown}" x-data="{ opendropdown: false }">
    <nav class="">
            ...
            <div class="w-11/12 sm:w-3/5 xl:w-3/4 mx-auto xl:flex xl:flex-row xl:items-center xl:justify-between">
                <div class="flex flex-row items-center justify-between xl:w-1/6">
                    ...
                    <button class="p-1 outline-none hover:outline-none focus:outline-none xl:hidden" @click="opendropdown = !opendropdown;">
                        <svg viewBox="0 0 20 20" fill="currentColor" class="menu-alt3 w-6 h-6 text-ib-one">
                ...
                <div :class="{'block': opendropdown, 'hidden': !opendropdown}" class="xl:flex xl:flex-row xl:items-center xl:justify-between mt-6 xl:mt-0 sm:pb-10 xl:pb-0 w-full min-h-screen xl:min-h-0 z-40">
                    <form action="{{ route('blog.post.search') }}" method="get" class="flex flex-row items-center justify-center py-1 px-3 xl:py-1 shadow-md xl:shadow-none rounded-md border border-solid border-gray-500 xl:w-full xl:mx-auto xl:ml-6">
                        ...
                        <input type="search" name="q" class="w-full ml-2 px-2 outline-none hover:outline-none bg-transparent text-ib-one" placeholder="Pencarian Artikel" value="{{ $search_text ?? null }}">
                    </form>
                    <div class="w-full h-full sm:h-64 xl:h-auto sm:overflow-y-auto xl:overflow-hidden text-center xl:text-right mt-8 xl:mt-0">
                        <ul>
                            <li class="mb-3 xl:mb-0 xl:inline-block">
                                <a href="{{ route('index') }}" class="block px-3 text-ib-one hover:text-ib-three">Home</a>
                            </li>
                            <li class="mb-3 xl:mb-0 xl:inline-block">
                                <a href="{{ route('index') }}/#portfolio-section" class="block px-3 text-ib-one hover:text-ib-three">Portfolio</a>
                            </li>
                            <li class="mb-3 xl:mb-0 xl:inline-block">
                                <a href="{{ route('index') }}/#skills-section" class="block px-3 text-ib-one hover:text-ib-three">Skills</a>
                            </li>
                            <li class="mb-3 xl:mb-0 xl:inline-block">
