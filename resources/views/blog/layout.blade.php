...
<body class="flex flex-col min-h-screen justify-between text-sm lg:text-base" :class="opendropdown ? 'overflow-hidden' : 'overflow-y-auto'" x-data="{ opendropdown: false }">
    ...
    <main class="mt-16 xl:mt-4 mb-auto pt-4 pb-10">
        @yield('content')
    </main>
