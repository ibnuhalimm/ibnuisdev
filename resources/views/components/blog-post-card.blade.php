<a href="{{ route('blog.post.read', [ 'slug' => $slug ]) }}" class="block w-full py-3 xl:py-0 rounded-md outline-none hover:outline-none text-ib-one hover:text-ib-three transition-all duration-500">
    <div class="flex flex-row items-start justify-between">
        ...
        <div class="w-2/3 lg:w-3/5 xl:w-7/12 flex flex-col items-start justify-between py-1">
            <div class="-ml-2 sm:-ml-4 md:-ml-8">
