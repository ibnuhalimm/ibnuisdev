<a href="{{ route('blog.post.read', [ 'slug' => $slug ]) }}" class="block w-full py-3 xl:py-0 rounded-md outline-none hover:outline-none text-ib-one hover:text-ib-three transition delay-100">
