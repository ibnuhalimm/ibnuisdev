                ...
                <div class="flex flex-col lg:flex-row justify-between">
                    <div class="mb-10 lg:mb-0 lg:w-1/4 lg:order-last">
                        ...
                        <div class="mt-3 flex flex-row justify-start mb-4">
                            ...
                            <a href="#" target="_blank" title="Twitter" rel="noopener noreferrer" class="w-10 h-10 flex items-center justify-center bg-white mx-1 border border-solid border-ib-one hover:border-ib-three text-ib-one hover:text-ib-three rounded-full">
                            ...
                            <a href="#" target="_blank" title="Linkedin" rel="noopener noreferrer" class="w-10 h-10 flex items-center justify-center bg-white mx-1 border border-solid border-ib-one hover:border-ib-three text-ib-one hover:text-ib-three rounded-full">
