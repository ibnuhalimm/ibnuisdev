            ...
            <div class="flex flex-col lg:flex-row lg:justify-between">
                <div class="flex flex-col items-center justify-center mb-10 lg:mt-4 xl:mt-0 lg:order-last">
                    ...
                    <div class="mt-6 lg:mt-4 flex flex-row items-center justify-center">
                        <a href="#" target="_blank" title="Github" rel="noopener noreferrer" class="w-10 h-10 lg:w-8 lg:h-8 flex items-center justify-center bg-white mx-1 border border-solid border-ib-one hover:border-ib-three hover:text-ib-three transition-all duration-500 rounded-full">
                        ...
                        <a href="#" target="_blank" title="Twitter" rel="noopener noreferrer" class="w-10 h-10 lg:w-8 lg:h-8 flex items-center justify-center bg-white mx-1 border border-solid border-ib-one hover:border-ib-three hover:text-ib-three transition-all duration-500 rounded-full">
                        ...
                        <a href="#" target="_blank" title="Linkedin" rel="noopener noreferrer" class="w-10 h-10 lg:w-8 lg:h-8 flex items-center justify-center bg-white mx-1 border border-solid border-ib-one hover:border-ib-three hover:text-ib-three transition-all duration-500 rounded-full">
