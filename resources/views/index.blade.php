            ...
            <div class="flex flex-col lg:flex-row lg:justify-between">
                <div class="flex flex-col items-center justify-center mb-10 lg:mt-4 xl:mt-0 lg:order-last">
                    ...
                    <div class="mt-6 lg:mt-4 flex flex-row items-center justify-center">
                        ...
                        <a href="{{ $user->upwork ?? '#' }}" target="_blank" title="Upwork" rel="noopener noreferrer" class="w-10 h-10 lg:w-8 lg:h-8 flex items-center justify-center bg-white mx-1 border border-solid border-ib-one hover:border-ib-three hover:text-ib-three transition-all duration-500 rounded-full">
                            <svg class="w-6 lg:w-5 h-auto" id="Layer_1" style="enable-background:new 0 0 56.7 56.7;" version="1.1" viewBox="0 0 56.7 56.7" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
