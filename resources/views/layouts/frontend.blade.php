...
<body class="flex flex-col min-h-screen justify-between text-sm xl:text-base text-ib-one" :class="opendropdown ? 'overflow-hidden' : 'overflow-y-auto'" x-data="{ opendropdown: false, is_modal_open: false }">
            ...
            <div :class="opendropdown ? 'block' : 'hidden'" class="w-4/5 md:w-3/5 lg:w-2/5 xl:w-full mx-auto xl:flex xl:flex-row xl:items-center xl:justify-end mt-6 xl:mt-0 sm:pb-10 xl:pb-0 min-h-screen xl:min-h-0 z-40">
                ...
                <div class="w-full h-full sm:h-32 md:h-full xl:h-auto sm:overflow-y-scroll xl:overflow-hidden text-center xl:text-left mt-8 xl:mt-0">
                    <ul class="list-none">
                        ...
                        <li class="mb-3 xl:mb-0 xl:inline-block">
                            <a href="{{ route('portfolio') }}" class="text-lg xl:text-base block py-2 xl:py-0 px-3 text-ib-one hover:underline">
                                Portofolio
                            </a>
                        </li>
                        <li class="mb-3 xl:mb-0 xl:inline-block">
    ...
    <footer class="w-full pt-10 pb-8 bg-ib-one text-ib-four">
        <x-frontend-container class="text-center flex flex-col lg:flex-row lg:items-center lg:justify-between">
